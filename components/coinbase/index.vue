  ...
  <div class="cbase-container">
    <ClientOnly>
      ...
      <a-card class="blockchain-card">
        ...
        <template #extra>
          <span class="wallet-info awallet">AWallet:&nbsp;{{ awallet }}&nbsp;Bells</span>
          <span class="wallet-info bwallet">BWallet:&nbsp;{{ bwallet }}&nbsp;Bells</span>
          <span class="wallet-info cwallet">CWallet:&nbsp;{{ cwallet }}&nbsp;Bells</span>
...
.workspace-row {
  margin-top: 40px; /* Converted inline style to class */
}

.blockchain-card {
  display: flex;
  flex-direction: column;
  margin-top: 20px; /* Converted inline style to class */
  margin-bottom: 20px;
...
.wallet-info {
  margin-right: 300px; /* Common class for wallet info */
  color: #00b300;
}

.card-title {
  font-size: 18px;
  color: #f14545; /* Converted inline style to class */
}
