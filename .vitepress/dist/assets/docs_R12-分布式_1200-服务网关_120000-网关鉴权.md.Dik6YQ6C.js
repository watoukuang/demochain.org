import{_ as i,C as p,c as e,o as l,j as a,G as t,ai as h,a as k}from"./framework-Cfw8I1ux.js";const A=JSON.parse('{"title":"网关鉴权","description":"","frontmatter":{},"headers":[],"relativePath":"docs/R12-分布式/1200-服务网关/120000-网关鉴权.md","filePath":"docs/R12-分布式/1200-服务网关/120000-网关鉴权.md"}'),d={name:"docs/R12-分布式/1200-服务网关/120000-网关鉴权.md"};function r(c,s,o,g,y,E){const n=p("ArticleMetadata");return l(),e("div",null,[s[0]||(s[0]=a("h1",{id:"网关鉴权",tabindex:"-1"},[k("网关鉴权 "),a("a",{class:"header-anchor",href:"#网关鉴权","aria-label":'Permalink to "网关鉴权"'},"​")],-1)),t(n),s[1]||(s[1]=h(`<p>在多服务架构下，用户需访问多个业务模块，如订单、用户、支付等系统。若各系统独立认证，不仅体验割裂、开发成本高，还容易产生安全隐患。为此，需引入统一的 API 网关 + SSO + Redis 权限缓存 模式，实现以下目标： ✅ 用户只需登录一次，所有服务可无缝访问。 ✅ 通过网关实现统一鉴权、权限拦截、请求路由。 ✅ 利用 Redis 缓存权限与 Token，提高性能，减轻后端压力。 ✅ 提供灵活的权限体系，支持动态刷新与扩展。</p><h2 id="系统架构" tabindex="-1">系统架构 <a class="header-anchor" href="#系统架构" aria-label="Permalink to &quot;系统架构&quot;">​</a></h2><div class="language-lua vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">lua</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">+</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">------------+         +-----------+          +-------------+</span></span>
...
<span class="line"><span>end</span></span>
<span class="line"><span>@enduml</span></span></code></pre></div>`,16))])}const D=i(d,[["render",r]]);export{A as __pageData,D as default};
